...
class KinescopePlayerViewFactory : PlatformViewFactory(StandardMessageCodec.INSTANCE) {
    ...
    companion object {
        ...
        fun loadVideo(viewId: Int, videoId: String, result: MethodChannel.Result, config: Map<String, Any>? = null) {
        ...
        fun getDuration(viewId: Int, result: MethodChannel.Result) {
            ...
            if (control != null) {
                ...
                result.error("PLAYER_NOT_FOUND", "PlayerControl not found for viewId: $viewId", null)
            }
        }
    }
        ...
        try {
            ...
            playerView.onFullscreenButtonCallback = {
                ...
                if (useCustomFullscreen) {
                    Log.d(TAG, "Попытка отправить onTapFullscreen в Flutter, eventChannel=$eventChannel, viewId=$viewId, isFullscreen=${!(fullscreenStates[viewId] ?: false)}")
            ...
            val progressRunnable = object : Runnable {
                override fun run() {
                    ...
                    if (exoPlayer != null && exoPlayer.duration > 0) {
                        ...
                        val percent = (position.toDouble() / duration * 100).coerceIn(0.0, 100.0)
